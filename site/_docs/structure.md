    ...
    <tr>
      ...
      <td>
        <p>
          ...
          will autoload all YAML files in this directory (using either the `.yml`, `.yaml`, 
          `.json` or `csv` formats and extensions) and they will be accessible via `site.data`. If
