...
- [Ruby](https://www.ruby-lang.org/en/downloads/) (v1.9.3 or above for Jekyll 2; v2 or above for Jekyll 3; including development headers)
- [RubyGems](https://rubygems.org/pages/download)
- Linux, Unix, or Mac OS X
- [NodeJS](https://nodejs.org/), or another JavaScript runtime (for Jekyll 2 and
