...
- (Minor) Grammar & `.jekyll.yml` filename fixes ([#2911]({{ site.repository }}/issues/2911))
...
- No longer set `permalink: pretty` in the `.jekyll.yml` for the site template ([#2680]({{ site.repository }}/issues/2680))
...
- Use `_config.yaml` or `.jekyll.yml` (`.yml` takes precedence) ([#2406]({{ site.repository }}/issues/2406))
...
- Point "Blog migrations" page to http://import.jekyll.ymlrb.com ([#1732]({{ site.repository }}/issues/1732))
