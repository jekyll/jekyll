...
- Refactor `highlight` tag to behave like the `raw` tag ([#6821]({{ site.repository }}/issues/6821))
...
- Add Cache class ([#7169]({{ site.repository }}/issues/7169))
...
- Revert &#34;Cache converter in renderer&#34; ([#7326]({{ site.repository }}/issues/7326))
...
- Optimize rendering Liquid templates ([#7136]({{ site.repository }}/issues/7136))
...
- Use .markdown for page templates ([#7126]({{ site.repository }}/issues/7126))
...
- Add a script to profile docs with CI ([#7540]({{ site.repository }}/issues/7540))
- Test with Ruby 2.6 on AppVeyor ([#7518]({{ site.repository }}/issues/7518))
- dev: update gemspec ([#7425]({{ site.repository }}/issues/7425))
- Update rubocop to ~&gt; 0.63.1 ([#7489]({{ site.repository }}/issues/7489))
- Relax version constraint on classifier-reborn gem ([#7471]({{ site.repository }}/issues/7471))
- Bump RuboCop to v0.62.x ([#7449]({{ site.repository }}/issues/7449))
- Test with Ruby v2.6 ([#7438]({{ site.repository }}/issues/7438))
...
- dev: test oldest and latest Ruby only ([#7412]({{ site.repository }}/issues/7412))
- Bump RuboCop to v0.61.x ([#7401]({{ site.repository }}/issues/7401))
- Switch to `:install_if` for wdm gem ([#7372]({{ site.repository }}/issues/7372))
- Update excludes for CodeClimate Analyses ([#7365]({{ site.repository }}/issues/7365))
- Bump RuboCop to v0.60.x ([#7338]({{ site.repository }}/issues/7338))
...
- update yajl-ruby ([#7278]({{ site.repository }}/issues/7278))
- Bump Rubocop to v0.59.0 ([#7237]({{ site.repository }}/issues/7237))
...
- Lock Travis to Bundler-1.16.2 ([#7144]({{ site.repository }}/issues/7144))
...
- Example of CircleCI deployment through CircleCI v2 ([#7024]({{ site.repository }}/issues/7024))
- Update rubocop version to 0.57.x ### -docs ([#7078]({{ site.repository }}/issues/7078))
- Use assert_include ([#7093]({{ site.repository }}/issues/7093))
- Remember to release docs gem ([#7066]({{ site.repository }}/issues/7066))
- Update Rubocop&#39;s config ([#7050]({{ site.repository }}/issues/7050))
...
- yajl-ruby update to v1.4.0 ([#6976]({{ site.repository }}/issues/6976))
...
- add liquid tag jekyll-flickr ([#6946]({{ site.repository }}/issues/6946))
- Updated copy - fixed casing of SaaS on resources page. ([#6949]({{ site.repository }}/issues/6949))
- WIP: Do not advise users to install Jekyll outside of Bundler ([#6927]({{ site.repository }}/issues/6927))
- Don&#39;t prompt for sudo when installing with Ubuntu WSL ([#6781]({{ site.repository }}/issues/6781))
- Fix typo ([#6969]({{ site.repository }}/issues/6969))
...
- Document that _drafts need to be contained within the custom collection directory ([#6985]({{ site.repository }}/issues/6985))
- Change for passive voice. ([#7005]({{ site.repository }}/issues/7005))
- Added the CAT plugin to the plugin list ([#7011]({{ site.repository }}/issues/7011))
...
- Listed the jekyll-target-blank plugin in plugins list. ([#7046]({{ site.repository }}/issues/7046))
- Typo ([#7058]({{ site.repository }}/issues/7058))
- Add Hints for some Improved Travis Config in Doc ([#7049]({{ site.repository }}/issues/7049))
- Added plugin json-get. ([#7086]({{ site.repository }}/issues/7086))
- Update travis-ci.md to point out &#34;this is an example Gemfile&#34; ([#7089]({{ site.repository }}/issues/7089))
- Adding `jekyll-info` plugin ([#7091]({{ site.repository }}/issues/7091))
- GitHub enables you to use themes from other repos ([#7112]({{ site.repository }}/issues/7112))
...
- Add jekyll-xml-source ([#7114]({{ site.repository }}/issues/7114))
- Add the jekyll-firstimage filter plugin ([#7127]({{ site.repository }}/issues/7127))
...
- Add DEV Community&#39;s Jekyll tag to community page ([#7139]({{ site.repository }}/issues/7139))
...
- Add closing tags for &lt;a&gt; ([#7163]({{ site.repository }}/issues/7163))
...
- Add missing html end tag for code example in section &#39;For loops&#39; ([#7199]({{ site.repository }}/issues/7199))
...
- New docs ([#7205]({{ site.repository }}/issues/7205))
...
- Fix minor grammatical error ([#7215]({{ site.repository }}/issues/7215))
- Add developer.spotify.com to the Jekyll Showcase ([#7217]({{ site.repository }}/issues/7217))
...
- Minor whitespace fixes ([#7238]({{ site.repository }}/issues/7238))
- Explicit location of where to create blog.html ([#7241]({{ site.repository }}/issues/7241))
- Fix a small grammar error/typo in the docs ([#7260]({{ site.repository }}/issues/7260))
- Reference the build command options that allows multiple config files ([#7266]({{ site.repository }}/issues/7266))
- Update 10-deployment.md ([#7268]({{ site.repository }}/issues/7268))
...
- Add Isomer to showcase ([#7300]({{ site.repository }}/issues/7300))
- Added missing semicolon ([#7306]({{ site.repository }}/issues/7306))
- &#34;This restricts you...&#34; to &#34;This restricts your&#34; ([#7307]({{ site.repository }}/issues/7307))
- Add a link to Giraffe Academy&#39;s tutorial ([#7325]({{ site.repository }}/issues/7325))
- Grammar correction ([#7327]({{ site.repository }}/issues/7327))
...
- Update posts.md ([#7360]({{ site.repository }}/issues/7360))
- Add info how to deploy using pre-push git hook ([#7179]({{ site.repository }}/issues/7179))
- Textile is only supported through a converter plugin ([#7003]({{ site.repository }}/issues/7003))
- Add documentation for custom tag blocks ([#7359]({{ site.repository }}/issues/7359))
- Added 99inbound&#39;s Jekyll post to form resources ([#7348]({{ site.repository }}/issues/7348))
...
- Proposed re-wording of Sass note. :) ([#7392]({{ site.repository }}/issues/7392))
...
- Update resources.md ([#7396]({{ site.repository }}/issues/7396))
- Update resources.md ([#7397]({{ site.repository }}/issues/7397))
- Remove alt attribute from a tags ([#7407]({{ site.repository }}/issues/7407))
- Fix grammatical error in permalinks.md ([#7409]({{ site.repository }}/issues/7409))
- Fix BASH code-block in ubuntu.md ([#7420]({{ site.repository }}/issues/7420))
- zlib is missing ([#7428]({{ site.repository }}/issues/7428))
- Include docs for {% raw %}`{{ page.collection }}`{% endraw %} ([#7430]({{ site.repository }}/issues/7430))
- Permalink docs typo fixes ([#7459]({{ site.repository }}/issues/7459))
- Fixed unnecessary aticles and pronouns ([#7466]({{ site.repository }}/issues/7466))
- Grammatical correction ([#7464]({{ site.repository }}/issues/7464))
- Update resources.md ([#7472]({{ site.repository }}/issues/7472))
- Store SSL key and cert in site source ([#7473]({{ site.repository }}/issues/7473))
- Minor doc fixes ([#7495]({{ site.repository }}/issues/7495))
- Changed order of steps ([#7503]({{ site.repository }}/issues/7503))
...
- Add CloudSh to resource page. ([#7497]({{ site.repository }}/issues/7497))
- Check if var exists before include tag ([#7530]({{ site.repository }}/issues/7530))
- Added formX to form-backend resources ([#7536]({{ site.repository }}/issues/7536))
...
- v4.0 development post ([#6934]({{ site.repository }}/issues/6934))
