...
The inline styles used in `_includes/header.html` is not a best practice,
...
Notice that here you are referencing `styles.css` that is generated by Jekyll from the `styles.scss` you created earlier in `assets/css`.
