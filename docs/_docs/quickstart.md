...
* The `Gemfile` and `Gemfile.lock` files inform Bundler about the gem requirements in your site. If your site has these Gemfiles, you can omit `bundle exec` and just run `jekyll serve`.
