...
module Jekyll
  class Site
    ...
    class Cleaner
      ...
      def existing_files
        files = Set.new
        site.fs.glob(File.join(site.dest, "**", "*"), File::FNM_DOTMATCH) do |file|
      ...
      def parent_dirs(file)
        parent_dir = site.fs.dirname(file)
      ...
      # Returns a Set with the file paths
      def replaced_files
        new_dirs.select { |dir| site.fs.file?(dir) }.to_set
      end
