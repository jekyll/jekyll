    ...
    class Doctor < Command
      class << self
        ...
        def properly_gathered_posts?(site)
          ...
          inside_custom_collections_dir?(site, "_drafts") if site.show_drafts
        end
        ...
        def inside_custom_collections_dir?(site, directory)
          return true unless File.directory?(site.in_source_dir(directory))

          Jekyll.logger.warn "Warning:",
                             "Detected '#{directory}' directory outside custom `collections_dir`!"
          Jekyll.logger.warn "", "Please move '#{directory}' into the custom directory at " \
