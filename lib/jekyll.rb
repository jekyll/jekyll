...
module Jekyll
  ...
  autoload :LiquidHashWithArray, 'jekyll/liquid_hash_with_array'
  autoload :LiquidHashWithKeys,  'jekyll/liquid_hash_with_keys'
  autoload :LiquidHashWithValues,'jekyll/liquid_hash_with_values'
