...
* Have questions? Post them on the "Mailing List":http://groups.google.com/group/jekyll-rb or join us at #Jekyll on Freenode (chat.freenode.net)
...
* "A simple way to add draft posts.":https://gist.github.com/2870636  No plugins required.
* "Tips for working with GitHub Pages Integration.":https://gist.github.com/2890453 Code example reuse, and keeping documentation up to date.
