...
Note that when including the excerpt in the meta description tag you should use the `page.excerpt` variable. The post variable is only available in the above for loop. The page variable is always available in a template.
