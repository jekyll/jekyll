Feature: Site configuration
  ...
  Scenario: Limit the number of pages generated by most recent date
    Given I have a site in "./_site"
    And I have a configuration file with:
      | key         | value       |
      | limit_pages | 2           |
    And I have the following pages:
      | title   | content    |
      | Apples  | A page about apples  |
      | Oranges | A page about oranges |
      | Bananas | A page about bananas |
    When I run jekyll build
    Then I should get a zero exit status
    And the _site directory should exist
    And the "_site/bananas.html" file should exist
    And the "_site/oranges.html" file should exist
    And the "_site/apples.html" file should not exist
